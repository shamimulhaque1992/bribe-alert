      ...
      <>
         <header>
            <div className="tp-header-area">
                     ...
                     <div className="row align-items-center">
                        ...
                        <div className="col-xxl-4 col-xl-2">
                           <div className="header-logo text-center">
                              <Link to="/"><img style={{maxWidth:"90px"}} src="assets/img/logo/bribe-logo.png" className="img-fluid" alt="logo not found" />
                              </Link>
                           </div>
                        </div>
                        <div className="col-xxl-4 col-xl-5">
               ...
               <div className={sticky ? "sticky-menu tp-header-menu-area tp-transparent-header-menu header-sticky" :"tp-header-menu-area tp-transparent-header-menu header-sticky mt-3"}>
                     ...
                     <div className="row justify-content-xl-center align-items-center">
                        <div className="col-xl-2 col-8 tp-sticky-column">
                           <div className="tp-sticky-logo">
                              <Link to="/"><img style={{maxWidth:"100px"}} src="assets/img/logo/bribe-logo.png" className="img-fluid" alt="logo not found" /></Link>
                           </div>
                        </div>
